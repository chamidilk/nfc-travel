...
import com.fc.ux.web.util.GenericResponse;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleIllegalArgument(final RuntimeException ex, final WebRequest request) {
        ...
        final GenericResponse bodyOfResponse = new GenericResponse(ex.getMessage(), "useractivationerror");
    ...
    public @ResponseBody
    ModelAndView handleInternal(final RuntimeException ex, final WebRequest request) {
