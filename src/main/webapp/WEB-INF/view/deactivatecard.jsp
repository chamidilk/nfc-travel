...
<head>
<meta charset="utf-8"/>
<title>Deactivate | EV Point</title>
...
<div class="page-container">
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu page-sidebar-menu-light " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<jsp:include page="sidebar.jsp">
                	...
                	<jsp:param name="register_active_open" value="active open" />
                	<jsp:param name="register_open" value="open" />
                	<jsp:param name="evadmin" value="evadmin" />
                	<jsp:param name="deactivate" value="active" />
                </jsp:include>
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Deactivation <small>card deactivation</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="../ev/deactivatecard">Deactivate</a>
					</li>
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-green">
                                ...
                                <span class="caption-subject bold uppercase"> Deactivate Card</span>
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <form role="form">
                                <div class="form-body">
                                    ...
                                    <div class="form-group form-md-line-input has-info form-md-floating-label">
                                        <div class="input-group input-group-lg">
                                            <div class="input-group-control">
                                                ...
                                                <span class="help-block">enter mCash wallet account number (710000000)...</span>
                                            </div>
                                            <span class="input-group-btn btn-right">
                                            <button id="reg-button" class="btn green-haze" type="button" data-loading-text="Saving...">Search</button>
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group form-md-line-input form-md-floating-label has-success" >
                                        <input type="text" class="form-control" id="customerNic" disabled>
                                        <label for="form_control_1">Customer NIC</label>
                                    </div>
                                    <div class="form-group form-md-line-input form-md-floating-label has-success">
                                        <input type="text" class="form-control" id="mobileNumber" disabled>
                                        <label for="form_control_1">Customer Mobile Number</label>
                                    </div>
                                    <div class="form-group form-md-line-input form-md-floating-label has-success">
                                        <input type="text" class="form-control" id="latestActivity" disabled>
                                        <label for="form_control_1">Latest Activity</label>
                                    </div>

                                    <div class="form-group form-md-line-input form-md-floating-label has-success">
                                        <input type="text" class="form-control" id="adminId" disabled value="${loggedIn}">
                                        <label for="form_control_1">Logged in</label>
                                    </div>

                                </div>
                                <div class="form-actions noborder">
                                    <button type="button" class="btn red">Deactivate</button>
