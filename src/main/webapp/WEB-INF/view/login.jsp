...
<div class="content">
	...
	<form class="register-form" action="index.html" method="post">
        ...
        <!--<div class"form-group">
            <div class="g-recaptcha" data-sitekey="6Lf6DiITAAAAAHB9IlTjz8git1QdgqYLEkj4h__D"></div>
		...
		<div class="form-group">
            <label>
            <input type="checkbox" name="pin"/> I agree to activate this Service using the one time password adopted at the time of issuance of the EV Card
            </label>
