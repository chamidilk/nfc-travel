...
<head>
<meta charset="utf-8"/>
<title>Device Register | EV Point</title>
...
<link rel="stylesheet" type="text/css" href="https://cdn.mobitel.lk/assets/global/plugins/bootstrap-select/bootstrap-select.min.css"/>
<link rel="stylesheet" type="text/css" href="https://cdn.mobitel.lk/assets/global/plugins/select2/select2.css"/>
<link rel="stylesheet" type="text/css" href="https://cdn.mobitel.lk/assets/global/plugins/jquery-multi-select/css/multi-select.css"/>
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu page-sidebar-menu-light " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<jsp:include page="sidebar.jsp">
                	...
                	<jsp:param name="ev_register_d_c" value="active" />
                </jsp:include>
			</ul>
			<!-- END SIDEBAR MENU -->
		</div>
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="../ev/deviceregister">Add EV Device</a>
					</li>
			    ...
			    <div class="col-md-12 ">
                    <div class="portlet box blue ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i> Add EV Device
                            </div>
                            <!--
                            <div class="tools">
                            ...
                            <form class="form-horizontal" role="form" id="reg_form">
                                <div class="form-body">
                                    <div class="form-group">
                                        <label for="ocppUsername" class="col-md-2 control-label">Ocpp Username</label>
                                        <div class="col-md-4">
                                            <div class="input-icon">
                                                <i class="fa fa-user"></i>
                                                <input type="text" class="form-control" id="ocppUsername" placeholder="ocpp username" name="ocppUsername">
                                            </div>
                                        </div>
                                    </div>

                                    <div class="form-group password-strength">
                                        <label for="ocppPassword" class="col-md-2 control-label">Ocpp Password</label>
                                        <div class="col-md-4">
                                            <div class="input-icon">
                                                <i class="fa fa-lock"></i>
                                                <input type="password" class="form-control" id="ocppPassword" placeholder="ocpp password" name="ocppPassword">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="port" class="col-md-2 control-label">Charge Box Name</label>
                                        <div class="col-md-4">
                                          <div class="input-icon">
                                    ...
                                    <div class="form-group">
                                        <label for="chargeBoxIdentity" class="col-md-2 control-label">CB Code</label>
                                        <div class="col-md-4">
                                          <div class="input-icon">
                                              <i class="fa fa-flash"></i>
                                              <input type="text" class="form-control" id="chargeBoxIdentity" placeholder="charge box identity" name="chargeBoxIdentity">
                                          </div>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="cbType" class="control-label col-md-2">Charge Box Type</label>
                                        <div class="col-md-4">
                                            <select class="form-control" name='cbType' id="cbType">
                                                <option value="CIRCONTROL">CIRCONTROL</option>
                                                <option value="VEEFIL">VEEFIL</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="mcashMerchantId" class="control-label col-md-2">Mcash Merchant</label>
                                        <div class="col-md-4">
                                            <select class="form-control select2me" data-placeholder="Select..." name='merchantId' id="merchantId">
												<option value=""></option>
                                                <c:forEach var="merchant" items="${merchants}">
                                                    <option value='${merchant.id}'>${merchant.mcashOutletName}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>
...
<script type="text/javascript" src="https://cdn.mobitel.lk/assets/global/plugins/bootstrap-select/bootstrap-select.min.js"></script>
<script type="text/javascript" src="https://cdn.mobitel.lk/assets/global/plugins/select2/select2.min.js"></script>
<script type="text/javascript" src="https://cdn.mobitel.lk/assets/global/plugins/jquery-multi-select/js/jquery.multi-select.js"></script>


<script type="text/javascript" src="https://cdn.mobitel.lk/assets/global/plugins/fuelux/js/spinner.min.js"></script>
<script type="text/javascript" src="https://cdn.mobitel.lk/assets/global/plugins/bootstrap-fileinput/bootstrap-fileinput.js"></script>
<script type="text/javascript" src="https://cdn.mobitel.lk/assets/global/plugins/jquery-inputmask/jquery.inputmask.bundle.min.js"></script>
<script type="text/javascript" src="https://cdn.mobitel.lk/assets/global/plugins/jquery.input-ip-address-control-1.0.min.js"></script>
<script src="https://cdn.mobitel.lk/assets/global/plugins/bootstrap-pwstrength/pwstrength-bootstrap.min.js" type="text/javascript"></script>
<script src="https://cdn.mobitel.lk/assets/global/plugins/bootstrap-switch/js/bootstrap-switch.min.js" type="text/javascript"></script>
<script src="https://cdn.mobitel.lk/assets/global/plugins/jquery-tags-input/jquery.tagsinput.min.js" type="text/javascript"></script>
<script src="https://cdn.mobitel.lk/assets/global/plugins/bootstrap-maxlength/bootstrap-maxlength.min.js" type="text/javascript"></script>
<script src="https://cdn.mobitel.lk/assets/global/plugins/bootstrap-touchspin/bootstrap.touchspin.js" type="text/javascript"></script>
<script src="https://cdn.mobitel.lk/assets/global/plugins/typeahead/handlebars.min.js" type="text/javascript"></script>
<script src="https://cdn.mobitel.lk/assets/global/plugins/typeahead/typeahead.bundle.min.js" type="text/javascript"></script>
<script type="text/javascript" src="https://cdn.mobitel.lk/assets/global/plugins/ckeditor/ckeditor.js"></script>
