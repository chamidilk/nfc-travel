...
<head>
<meta charset="utf-8"/>
<title>Merchant View | EV Point</title>
...
<div class="page-container">
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu page-sidebar-menu-light " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<jsp:include page="sidebar.jsp">
                	...
                	<jsp:param name="ev_register_m_v" value="active" />
                </jsp:include>
			</ul>
			<!-- END SIDEBAR MENU -->
		</div>
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			View <small>merchant view</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="../ev/view">View EV Merchant</a>
					</li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-shopping-cart"></i>EV Merchants
                            </div>
                            <div class="actions">
                                <div class="btn-group">
                        ...
                        <div class="portlet-body">
                            <div class="table-container">
                                ...
                                <tr role="row" class="filter">
                                    ...
                                    <td>
                                        <input type="text" class="form-control form-filter input-sm" name="merchantName">
                                    </td>
                                    <td>
                                        <select name="merchantStatus" class="form-control form-filter input-sm">
