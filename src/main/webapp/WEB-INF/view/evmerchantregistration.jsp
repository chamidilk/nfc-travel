...
<head>
<meta charset="utf-8"/>
<title>Merchant Register | EV Point</title>
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu page-sidebar-menu-light " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<jsp:include page="sidebar.jsp">
                    ...
                    <jsp:param name="ev_merchant_open" value="open" />
                    <jsp:param name="ev_admin" value="ev_admin" />
                	<jsp:param name="ev_register_m_c" value="active" />
                </jsp:include>
			</ul>
			<!-- END SIDEBAR MENU -->
		</div>
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="../ev/merchantregister">Add EV Merchant</a>
					</li>
			    ...
			    <div class="col-md-12 ">
                    <div class="portlet box blue ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i> Add EV Merchant
                            </div>
                            <!--
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            ...
                            <form class="form-horizontal" role="form" id="reg_form">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        <label for="password_a" class="col-md-2 control-label">Password Again</label>
                                        <div class="col-md-4">
                                            <div class="input-icon">
                                                <i class="fa fa-lock"></i>
                                                <input type="password" class="form-control" id="password_a" placeholder="password again" name="matchingPassword">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-icon">
                                                ...
                                                <input type="text" class="form-control" id="mobileNumber" placeholder="mobile no" name="mobileNumber">
                                            </div>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="nicNumber" class="col-md-2 control-label">Nic Number</label>
                                        <div class="col-md-4">
                                            <div class="input-icon">
                                                <i class="fa fa-lock"></i>
                                                <input type="text" class="form-control" id="nicNumber" placeholder="nic number" name="nicNumber">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="select_selectsplitter1" class="col-md-2 control-label">Role</label>
                                        <div class="col-md-9">
                                            <select multiple id="select_selectsplitter1" class="form-control" size="4" name='role'>
                                    ...
                                    <div class="form-group">
                                        <label for="mcashOutletId" class="control-label col-md-2">Mcash Merchant</label>
                                        <div class="col-md-4">
                                            <select class="form-control input-xlarge select2me" data-placeholder="Select..." name='mcashOutletId' id="mcashOutletId">
												<option value=""></option>
                                                <c:forEach var="outlet" items="${outlets}">
                                                    <option value='${outlet.mcashOutletId}'>${outlet.mcashOutletName}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>
