...
<head>
<meta charset="utf-8"/>
<title>EV Account | EV Point</title>
...
<div class="page-container">
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu page-sidebar-menu-light " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<jsp:include page="sidebar.jsp">
                	...
                	<jsp:param name="reporting_evaccount" value="active" />
                </jsp:include>
			</ul>
			<!-- END SIDEBAR MENU -->
		</div>
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Reporting <small>ev account</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="../ev/register">EV Account</a>
					</li>
			    ...
			    <div class="col-md-12 ">
                    <div class="portlet box blue ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i> EV Account
                            </div>
                            <!--
                            <div class="tools">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="">
                                                    <select class="form-control select2me" data-placeholder="Select..." id="userId" name="userId">
                                                        <option value=""></option>
                                                        <c:forEach var="card" items="${cards}">
                                                            <option value='${card.user.id}'>${card.cardNumber}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                            </div>
