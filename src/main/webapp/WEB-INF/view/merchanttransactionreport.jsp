...
<head>
<meta charset="utf-8"/>
<title>Merchant Transactions | EV Point</title>
...
<div class="page-container">
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu page-sidebar-menu-light " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<jsp:include page="sidebar.jsp">
                	...
                	<jsp:param name="reporting_active_open" value="active open" />
                	<jsp:param name="reporting_open" value="open" />
                	<jsp:param name="reporting_merchant_transaction" value="active" />
                </jsp:include>
			</ul>
			<!-- END SIDEBAR MENU -->
		</div>
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Reporting <small>merchant transactions</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="../ev/register">Merchant Transactions</a>
					</li>
			    ...
			    <div class="col-md-12 ">
                    <div class="portlet box blue ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i> Find Merchant Transactions
                            </div>
                            <!--
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            ...
                            <form class="horizontal-form" role="form" id="reg_form">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="">
                                                    <select class="form-control select2me" data-placeholder="Select..." id="merchantId" name="merchantId">
                                                        <option value=""></option>
                                                        <c:forEach var="merchant" items="${merchants}">
                                                            <option value='${merchant.id}'>${merchant.merchant.merchantName}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label">Charging Station</label>
                                                <div class="">
                                                    <select class="form-control select2me" data-placeholder="Select..." id="cbid" name="chargingStationId">
                                                        <option value=""></option>
                                                        <c:forEach var="chargingStation" items="${chargingStations}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="">
                                                    <div class="input-group input-large date-picker input-daterange" data-date="10/11/2012" data-date-format="mm/dd/yyyy">
                                                        <input type="text" class="form-control" name="fromDate" id="from">
                                                        <span class="input-group-addon">
                                                        to </span>
                                                        <input type="text" class="form-control" name="toDate" id="to">
                                                    </div>
                                                    <!-- /input-group -->
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            <input type="hidden" value="pdf" name="type" id="type">
                                            <button type="button" class="btn blue"  id="form_pdf">PDF</button>
                                            <button type="button" class="btn green"  id="form_xls">XLS</button>
...
<script src="https://cdn.mobitel.lk/assets/admin/pages/scripts/transaction.js" type="text/javascript"></script>
