		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu page-sidebar-menu-light " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<jsp:include page="sidebar.jsp">
                	...
                	<jsp:param name="ev_register_c" value="active" />
                </jsp:include>
			</ul>
			<!-- END SIDEBAR MENU -->
		</div>
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="../ev/register">Add EV User</a>
					</li>
			    ...
			    <div class="col-md-12 ">
                    <div class="portlet box blue ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i> Add EV User
                            </div>
                            <!--
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            ...
                            <form class="form-horizontal" role="form" id="reg_form">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        <label for="idm" class="col-md-2 control-label">Idm Number</label>
                                        <div class="col-md-4">
                                            <div class="input-icon">
                                                <i class="fa fa-credit-card"></i>
                                                <input type="text" class="form-control" id="idm" placeholder="idm number" name="idm">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="cardIssuerBlockId" class="col-md-2 control-label">Card Block</label>
                                        <div class="col-md-4">
                                            <select class="form-control" name='cardIssuerBlockId' id="cardIssuerBlockId">
                                                <c:forEach var="cardBlock" items="${cardBlocks}">
                                                    <option value='${cardBlock.cardBlcokId}'>${cardBlock.cardBlockName}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-2">Activation Date</label>
                                        <div class="col-md-4">
                                            <div class="input-group input-medium date date-picker" data-date="12-02-2012" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                                                <input type="text" class="form-control" readonly name='activationDate'>
                                                <span class="input-group-btn">
                                                <button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
                                                </span>
                                            </div>
