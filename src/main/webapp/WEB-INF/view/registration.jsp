		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu page-sidebar-menu-light " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<jsp:include page="sidebar.jsp">
                	...
                	<jsp:param name="register_c" value="active" />
                </jsp:include>
			</ul>
			<!-- END SIDEBAR MENU -->
		</div>
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="../user/register">Add User</a>
					</li>
                        ...
                        <div class="portlet-body form">
                            ...
                            <form class="form-horizontal" role="form" id="reg_form">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        <label for="inputPassword1" class="col-md-2 control-label">Role</label>
                                        <div class="col-md-9">
                                            <select multiple id="select_selectsplitter1" class="form-control" size="4">
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            <button type="submit" class="btn green"  id="form_submit">Submit</button>
