		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu page-sidebar-menu-light " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<jsp:include page="sidebar.jsp">
                	...
                	<jsp:param name="ev_register_v" value="active" />
                </jsp:include>
			</ul>
			<!-- END SIDEBAR MENU -->
		</div>
                        ...
                        <div class="portlet-body">
                            <div class="table-container">
                                ...
                                <tr role="row" class="filter">
                                    ...
                                    <td>
                                        <input type="text" class="form-control form-filter input-sm" name="cardNumber">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control form-filter input-sm" name="uid">
                                    </td>
                                    <td>
                                        <select name="cardStatus" class="form-control form-filter input-sm">
