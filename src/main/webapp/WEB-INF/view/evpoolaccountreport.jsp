...
<head>
<meta charset="utf-8"/>
<title>EV Pool Account | EV Point</title>
...
<div class="page-container">
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu page-sidebar-menu-light " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<jsp:include page="sidebar.jsp">
                	...
                	<jsp:param name="reporting_evpoolaccount" value="active" />
                </jsp:include>
			</ul>
			<!-- END SIDEBAR MENU -->
		</div>
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Reporting <small>ev pool account</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="../ev/register">EV Pool Account</a>
					</li>
			    ...
			    <div class="col-md-12 ">
                    <div class="portlet box blue ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i> EV Pool Account
                            </div>
                            <!--
                            <div class="tools">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="">
                                                    <select class="form-control select2me" data-placeholder="Select..." id="narration" name="narration">
                                                        <option value="">BOTH</option>
                                                        <option value="POOL_CREDIT">POOL_CREDIT</option>
                                                        <option value="POOL_DEBIT">POOL_DEBIT</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
